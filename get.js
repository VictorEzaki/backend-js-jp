...
app.get("/exercicio3", (req, res) => {
    ...
    res.json({ result: `A média de peso entre as 5 pessoas: ${result} `})
})
...
app.get("/exercicio4", (req, res) => {
    ...
    console.log('Hello World')
    res.json({ result: `${temp}C° em Fahrenheit é: ${result} `})
})
...
app.get("/exercicio5", (req, res) => {
    ...
    console.log('Hello World')
    res.json({ result: `${milhas} em Quilomêtros é: ${result}km`})
})
